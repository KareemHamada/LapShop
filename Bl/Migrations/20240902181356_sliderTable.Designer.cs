...
namespace LapShop.Migrations
{
    ...
    [Migration("20240902181356_sliderTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bl.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Bl.TbBusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Bl.TbCashTransacion", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Bl.TbCategory", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Bl.TbCustomer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Bl.TbItem", b =>
                {
                    ...
                    b.Property<int?>("TbSliderSliderId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Bl.TbItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Bl.TbItemImage", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Bl.TbItemType", b =>
                {
                    b.Property<int>("ItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Bl.TbO", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Bl.TbPages", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Bl.TbPurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Bl.TbPurchaseInvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Bl.TbSalesInvoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Bl.TbSalesInvoiceItem", b =>
                {
                    b.Property<int>("InvoiceItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Bl.TbSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Bl.TbSlider", b =>
                {
            ...
            modelBuilder.Entity("LapShop.Bl.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Bl.VwItem", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Bl.VwItemCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShop.Bl.VwItemsOutOfInvoice", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("LapShop.Bl.VwSalesInvoice", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LapShop.Bl.TbBusinessInfo", b =>
                {
                    b.HasOne("LapShop.Bl.TbCustomer", "Cutomer")
                        .WithOne("TbBusinessInfo")
                        .HasForeignKey("LapShop.Bl.TbBusinessInfo", "CutomerId")
            ...
            modelBuilder.Entity("LapShop.Bl.TbItem", b =>
                {
                    b.HasOne("LapShop.Bl.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TbItems_TbCategories");

                    b.HasOne("LapShop.Bl.TbItemType", "ItemType")
                        .WithMany("TbItems")
                        .HasForeignKey("ItemTypeId")
                        .HasConstraintName("FK_TbItems_TbItemTypes");

                    b.HasOne("LapShop.Bl.TbO", "Os")
                        .WithMany("TbItems")
                        .HasForeignKey("OsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("LapShop.Bl.TbSlider", null)
                        .WithMany("TbItems")
                        .HasForeignKey("TbSliderSliderId");
            ...
            modelBuilder.Entity("LapShop.Bl.TbItemDiscount", b =>
                {
                    b.HasOne("LapShop.Bl.TbItem", "Item")
            ...
            modelBuilder.Entity("LapShop.Bl.TbPurchaseInvoice", b =>
                {
                    b.HasOne("LapShop.Bl.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("LapShop.Bl.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("LapShop.Bl.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("LapShop.Bl.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("LapShop.Bl.TbSalesInvoice", "Invoice")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Bl.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    b.HasOne("LapShop.Bl.TbCustomer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LapShop.Bl.TbItem", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
