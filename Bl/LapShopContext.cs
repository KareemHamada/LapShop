...
{
    public partial class LapShopContext : IdentityDbContext<ApplicationUser,ApplicationRole,string>
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=DESKTOP-C2BTGLA;Database=LapShop;Trusted_Connection=True;Encrypt=False");
